...
/**
 * Thymeleaf is excluded: main.html references "${_csrf.headerName}", which
 * is only populated by Spring Security's CsrfFilter. Security filters are
...
@Import(IndexControllerTest.NoOpViewResolverConfig.class)
